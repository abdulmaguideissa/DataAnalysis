...
/*
    a query that displays the order date and gloss_qty data for all 
    orders where gloss_qty is between 24 and 29. 
    Note That: the result includes the two endpoints of the condition.
*/
...
/*
    Use the web_events table to find all information regarding individuals
     who were contacted via the organic or adwords channels, and started 
     their account at any point in 2016, sorted from newest to oldest.
     Note That: BETWEEN is exclusive with timestamp.
*/
SELECT *
    FROM web_events
